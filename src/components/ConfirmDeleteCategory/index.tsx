...
const ModalConfirmDeleteCategory = forwardRef(
  function ModalConfirmDeleteCategory({ onDelete }: any, ref) {
      ...
      >
        <View style={styles.modalView}>
          ...
          <RegularText style={styles.textAction}>
            Are you sure to delete this category, all tasks of this category
            will be removed?
          </RegularText>
