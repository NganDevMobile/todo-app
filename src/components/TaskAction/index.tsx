...
import { TASK_ACTION } from '@constants/data';
...
const ModalTaskAction = forwardRef(function ModalTaskAction(
  { onSelect }: any,
  ref,
) {
  ...
  const renderAction = (item: TaskAction) => {
    ...
    if (type === 'EDIT' && isCompleted) return null;
